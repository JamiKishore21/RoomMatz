...
const VerifyCode = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("");
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/users/verify-code`, { email, code });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-gray-900 via-slate-900 to-black p-4 font-sans text-foreground">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-10 w-72 h-72 bg-gradient-to-br from-blue-400/20 to-indigo-600/20 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-gradient-to-br from-purple-400/20 to-pink-600/20 rounded-full blur-3xl animate-float-slow"></div>
      </div>
        ...
        <CardContent className="pt-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="code" className="text-sm font-semibold text-gray-300 flex items-center gap-2">
              ...
              <Input
                ...
                required
                className="h-12 border-2 border-white/10 bg-gray-700/50 text-white placeholder:text-gray-500 focus:border-blue-500 transition-all duration-300 text-center tracking-[0.5em] font-black text-xl"
              />
            </div>
